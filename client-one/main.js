const {app, BrowserWindow, screen, Menu, MenuItem, globalShortcut, ipcMain,nativeImage} = require('electron')
const windowStateKeeper = require('electron-window-state')
const net = require('net');

const image = nativeImage.createFromPath(__dirname + '/assets/images/icon.ico')
